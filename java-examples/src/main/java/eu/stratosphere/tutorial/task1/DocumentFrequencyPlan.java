...
public class DocumentFrequencyPlan implements Program, ProgramDescription {
	...
	public static void main(String[] args) throws Exception {
		...
		Util.createTempFile("input/1.txt", "1,Big Hello to big shashika Stratosphere! :-)");
		...
		//Util.deleteAllTempFiles();    //you can find out temporary file in /tmp/ directory by commenting this
	}
}
